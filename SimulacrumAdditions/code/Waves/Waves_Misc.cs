...
namespace SimulacrumAdditions
{
    public class Waves_Misc
    {
        ...
        internal static void MakeWaves()
        {
            ...
            InfiniteTowerWaveAlwaysJumping.GetComponent<InfiniteTowerWaveController>().rewardDropTable = Const.dtITCategoryUtility;
            ...
            InfiniteTowerWaveCategory.WeightedWave AlwaysJumpingWave = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = InfiniteTowerWaveAlwaysJumping, weight = 2.5f, prerequisites = Const.AfterWave5Prerequisite };
            Const.ITBasicWaves.wavePrefabs = Const.ITBasicWaves.wavePrefabs.Add(AlwaysJumpingWave);
            #endregion
            ...
            InfiniteTowerWaveSurprise.GetComponent<InfiniteTowerWaveController>().rewardDropTable = Const.dtITBasicBonusGreen;
            ...
            InfiniteTowerWaveCategory.WeightedWave ITBasicSurprise = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = InfiniteTowerWaveSurprise, weight = 4f, prerequisites = Const.StartWave15Prerequisite };
            Const.ITBasicWaves.wavePrefabs = Const.ITBasicWaves.wavePrefabs.Add(ITBasicSurprise);
            #endregion
            ...
            GameObject WaveBoss_VoidElites = PrefabAPI.InstantiateClone(Const.ScavWave, "WaveBoss_VoidElites", true);
            ...
            WaveBoss_VoidElites.GetComponent<InfiniteTowerWaveController>().rewardDropTable = Const.dtITVoidInfestorWave;
            ...
            InfiniteTowerWaveCategory.WeightedWave ITBossVoidElites = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = WaveBoss_VoidElites, weight = 8f, prerequisites = Const.AfterWave5Prerequisite }; //7 normally
            Const.ITBossWaves.wavePrefabs = Const.ITBossWaves.wavePrefabs.Add(ITBossVoidElites);
            #endregion
            #region (Boss) Double Boss / Mountain
            //Mountain Boss
            GameObject InfiniteTowerWaveDoubleBoss = PrefabAPI.InstantiateClone(Const.BossWave, "InfiniteTowerWaveDoubleBoss", true);
            ...
            InfiniteTowerWaveDoubleBoss.AddComponent<SimulacrumExtrasHelper>().rewardDropTable = Const.dtITWaveTier2;
            ...
            InfiniteTowerWaveCategory.WeightedWave ITDoubleBoss = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = InfiniteTowerWaveDoubleBoss, weight = 10f, prerequisites = Const.StartWave11Prerequisite };
             Const.ITBossWaves.wavePrefabs = Const.ITBossWaves.wavePrefabs.Add(ITDoubleBoss);
            #endregion
            #region (Boss) Wave with Flame Drones
            //Wave with the drone in it
            GameObject WaveBoss_WithDrone = PrefabAPI.InstantiateClone(Const.ScavWave, "WaveBoss_WithDrone", true);
            GameObject WaveBoss_DronesMachinesUI = PrefabAPI.InstantiateClone(Const.BossWaveUI, "WaveBoss_WithDroneUI", false);

            WaveBoss_WithDrone.GetComponent<InfiniteTowerWaveController>().baseCredits = 450f;
            WaveBoss_WithDrone.GetComponent<InfiniteTowerWaveController>().rewardDropTable = Const.dtITBossCategoryUtility;
            ...
            InfiniteTowerWaveCategory.WeightedWave ITWaveBoss_WithDrone = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = WaveBoss_WithDrone, weight = 6f, prerequisites = Const.StartWave20Prerequisite };
             Const.ITBossWaves.wavePrefabs = Const.ITBossWaves.wavePrefabs.Add(ITWaveBoss_WithDrone);
            #endregion

            #region (Boss) Eclipse 8
            //ITBossEclipse8
            GameObject WaveBoss_Eclipse8 = PrefabAPI.InstantiateClone(Const.BossWave, "WaveBoss_Eclipse8", true);
            GameObject WaveBoss_Eclipse8UI = PrefabAPI.InstantiateClone(Const.BossWaveUI, "WaveBoss_Eclipse8", false);
            ...
            WaveBoss_Eclipse8.GetComponent<InfiniteTowerWaveController>().rewardDropTable = Const.dtITWaveTier3;
            ...
            InfiniteTowerWaveCategory.WeightedWave ITBossEclipse8 = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = WaveBoss_Eclipse8, weight = 4f, prerequisites = Const.StartWave20Prerequisite };
             Const.ITBossWaves.wavePrefabs = Const.ITBossWaves.wavePrefabs.Add(ITBossEclipse8);
            #endregion
            ...
            InfiniteTowerWaveCategory.WeightedWave ITMeridianStorm = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = InfiniteTowerWaveMeridianStorm, weight = 2f, prerequisites = Const.DLC2_StartWave15Prerequisite };
            Const.ITBasicWaves.wavePrefabs = Const.ITBasicWaves.wavePrefabs.Add(ITMeridianStorm);
            #endregion
            ...
            InfiniteTowerWaveKnockback.GetComponent<InfiniteTowerWaveController>().rewardDropTable = Const.dtITCategoryUtility;
            ...
            InfiniteTowerWaveCategory.WeightedWave ITKnockback = new InfiniteTowerWaveCategory.WeightedWave { wavePrefab = InfiniteTowerWaveKnockback, weight = 3f, prerequisites = Const.StartWave11Prerequisite };
            Const.ITBasicWaves.wavePrefabs = Const.ITBasicWaves.wavePrefabs.Add(ITKnockback);
            #endregion
        }
